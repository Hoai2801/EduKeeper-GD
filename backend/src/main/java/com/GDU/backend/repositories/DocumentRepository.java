...
public interface DocumentRepository extends JpaRepository<Document, Long> {
    ...
    List<Document> getDocumentsSuggested(@Param("categoryId") Long categoryId, @Param("departmentId") Long departmentId,
            @Param("subjectId") Long subjectId, @Param("type") String type);
}
