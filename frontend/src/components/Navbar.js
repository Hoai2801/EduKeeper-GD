...
const Navbar = () => {
    ...
    const [userLoadSuccess, setUserLoadSuccess] = useState(false);
    ...
    useEffect(() => {
            if (jwtDecoded !== null && jwtDecoded?.jwtDecoded) {
                            ...
                            <div className="flex flex-col items-center w-full mt-3 gap-3 px-4">
                                ...
                                <div className="flex flex-col gap-3 w-full items-center">
                                    ...
                                    <div
                                        ...
                                        onMouseLeave={() => setIsShownCategory(false)}>
                                        {category && category?.map((item, index) => (
                                            <Link to={`/search?category=${item.categorySlug}&order=lastest`}
                                                  key={index}
