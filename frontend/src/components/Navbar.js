...
const Navbar = () => {
  ...
  const [notification, setNotification] = useState([
    {
      _check: false,
      document: "document-slug-1",
      title: "New Document Available",
      content: "A new document has been uploaded to your course.",
      created_at: "2024-08-22T08:00:00Z",
    },
    {
      _check: true,
      document: "document-slug-2",
      title: "Assignment Due Soon",
      content: "Your assignment is due in 3 days.",
      created_at: "2024-08-21T14:30:00Z",
    },
    {
      _check: false,
      document: "document-slug-3",
      title: "Grade Released",
      content: "Your grade for the midterm exam has been released.",
      created_at: "2024-08-20T10:45:00Z",
    },
  ]);
