            ...
            <div className='justify-center flex gap-5 w-full mt-5'>
                ...
                <div className='flex flex-col items-center mt-5'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <p className='text-gray-500'>MSSV: {jwt?.staff_code}</p>
                    </div>
            ...
            <div className='lg:flex flex-col text-lg w-full hidden'>
                ...
                <div className={`${documentMenuShow ? "block" : "hidden"} flex flex-col`}>
                    <Link to="document/upload"
                          className={`hover:rounded-xl hover:bg-[#C5D6F8] p-5 ml-10 ${jwt?.role === "student" ? "hidden" : ""}`}>Tài
                        liệu đã đăng</Link>
                ...
                <Link onClick={() => out()} to="notification" className='hover:rounded-xl hover:bg-[#C5D6F8] p-5'>
                    Đăng xuất
                </Link>
            </div>
        </div>
