            ...
            <div className='bg-white rounded-lg lg:w-[1200px] w-full h-fit shadow-2xl pt-5 mt-10 flex flex-col md:p-10 p-2'>
                ...
                <div className='ml-5 flex flex-col gap-5 items-center'>
                    {mostDownloaded?.map((item, index) => (
                        <Post key={index} title={item.title} author={item.author} upload_date={item.upload_date}
                              slug={item.slug} thumbnail={item.thumbnail}
                ...
                <div className='ml-5 flex flex-col gap-5 mt-5 items-center'>
                    ...
                    <div className='flex justify-center'>
                        <button onClick={null} className='text-white bg-blue-500 hover:bg-blue-300 rounded-md p-4'>Xem
                            thêm
                        </button>
                    </div>
                </div>
