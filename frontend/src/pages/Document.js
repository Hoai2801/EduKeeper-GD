      ...
      const res = async () => {
        try {
          ...
          if (response.status === 200) {
            toast.success("Duyệt tài liệu thành công!"); // Success message
  ...
  return (
    <div className="  py-4">
      <div className="mx-4  mt-2">
        <div className="flex xl:flex-row md:flex-row flex-col gap-y-3 justify-between">
          <div className="flex xl:gap-x-2 md:gap-x-2 gap-x-4">
            <button
              onClick={hanldeDisplayDocs}
              className={`xl:px-3 md:px-3 px-4 py-2 xl:h-9 md:h-9  rounded-3xl border-solid border border-gray-500 text-gray-500 text-sm font-medium ${
            ...
            <button
              ...
              className={`px-3 xl:h-9 md:h-9 rounded-3xl border-solid border border-gray-500 text-gray-500 text-sm font-medium ${
                activeButton === 1 ? "active-check" : ""
              }`}
              type="button"
            >
              <span>Tài liệu đợi duyệt ({draftCount || 0})</span>
            </button>
          </div>
                  ...
                  return (
                    <tbody>
                      ...
                      >
                        ...
                        <td class="px-6 py-4 "> {document.author} </td>
                        <td class="px-6 py-4 capitalize"> {document.scope}</td>
                        <td class="px-6 py-4 ">
                          {" "}
