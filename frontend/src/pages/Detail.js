        ...
        <div className={`w-full`}>
            ...
            <div
                ...
                <div className={`bg-white overflow-y-scroll h-screen rounded-lg flex flex-col max-w-[1080px] mt-5 mx-auto`}>
                    ...
                    <div>
                        <p className='text-center text-gray-500 text-xl font-semibold mt-3 mb-10 p-5'>{isContentLoading ? "Đã hết số trang được xem review. Để xem thêm các trang sau, vui lòng tải tài liệu để có trải nghiệm tốt nhất" : "Đang tải tài liệu"}</p>
                    </div>
                </div>
