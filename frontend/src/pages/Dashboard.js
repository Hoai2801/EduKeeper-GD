              ...
              {top3Docs &&
                  top3Docs.map((docs, index) => {
                    return (
                        <div
                            key={index}
                            className="my-2 min-h-32 w-full bg-white bg-clip-border rounded-xl shadow-md flex items-center p-2"
                        >
                          <div className="max-w-32 h-32 overflow-hidden rounded-xl ">
                            <img
                                src={
                                  docs.thumbnail
                          ...
                          <div className="min-w-48 min-h-8 max-w-60 ml-2">
                            <div className="">
