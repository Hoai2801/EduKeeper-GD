    ...
    <div className={``}>
      <div className={`bg-white rounded-lg p-3`}>
              ...
              {bannerList?.map((item) => {
                return (
                  <tr className="bg-white border-b hover:bg-gray-50">
                    ...
                    >
                      <img
                        src={`http://localhost:8080/api/v1/images/banner/${item.image}`}
                        alt=""
                        className={`w-32 h-32`}
                      />
                    </th>
        ...
        <div className={`${isEditShow ? "block" : "hidden"}`}>
          <div
            className={`bg-gray-500 opacity-65 absolute top-0 left-0 w-full h-full`}
          ></div>
          <div
            className={`w-full h-full absolute top-0 left-0 flex flex-col justify-center items-center`}
          >
            <div
              className={`xl:w-[500px] md:w-[500px] w-[320px] overflow-auto xl:h-4/5 h-fit bg-white rounded-lg p-2`}
            >
              ...
              >
                <div className={`${bannerEdit ? "hidden" : "block w-4/5"}`}>
                  <DragDropFile handleFiles={setFile} fileSupport={['image/png', 'image/jpeg', 'image/jpg', 'image/gif']} />
                </div>
                  ...
                  <img
                    src={
                      file
                        ...
                        : `http://localhost:8080/api/v1/images/banner/${bannerEdit?.image}`
                    }
                    alt=""
                    className={`w-full`}
                  />
              ...
              <div className={`p-5 flex flex-col gap-3`}>
                <div>
                  <label
                    htmlFor="active"
                    className={`font-bold text-[18px] my-5 mr-5`}
                  >
                    Hoạt động
                  </label>
                  <input
              ...
              <div className={`w-full h-[50px] flex justify-center`}>
                <button
                  onClick={bannerEdit ? handleEdit : handleCreate}
